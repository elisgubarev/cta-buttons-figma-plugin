...
export const buttonPropertiesCheerful: ButtonProperties = {
  name: "Cheerful Button",
  fills: {
    light: {
      primary: {
...
export const buttonTextPropertiesCheerful: ButtonTextProperties = {
  fontName: { family: "Lato", style: "Regular" },
  defaultText: "Give it a try",
  fontSize: 14,
...
export const arrowPropertiesCheerful: ArrowPropeties = {
  vectorPaths: [
    {
      windingRule: "NONZERO",
